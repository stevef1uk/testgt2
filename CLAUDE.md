...
**YOU ARE IN: `testgt2/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/testgt2/` (rig root) or other directories
...
**Your mail address:** `testgt2/polecats/rust`
**Your rig:** testgt2
**Your Witness:** `testgt2/witness`
...
| Ask Witness for help | `gt mail send testgt2/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`testgt2/witness`) when:
...
```bash
gt mail send testgt2/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
